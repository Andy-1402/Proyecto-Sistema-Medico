...
from doctor.const import CIVIL_CHOICES, SEX_CHOICES, TIPOS_SANGRE_CHOICES
...
class TipoSangre(models.Model):
    ...
    tipo = models.CharField(max_length=10, verbose_name="Tipo de Sangre", unique=True, choices=TIPOS_SANGRE_CHOICES)
    ...
    @staticmethod
    def cantidad_sangre():
       return TipoSangre.objects.all().count()
...
class Cargo(models.Model):
    ...
    @staticmethod
    def cantidad_cargos():
       return Cargo.objects.all().count()
...
class Empleado(models.Model):
    ...
    def cantidad_empleados():
       return Empleado.objects.all().count()
